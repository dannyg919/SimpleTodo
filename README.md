...
<img src='SimpleTodoGIF.gif' title='Video Walkthrough' width='200px' alt='Video Walkthrough' />
...
- Getting used to Android Studio for the first time

- Understanding RecyclerView and all of its parts
